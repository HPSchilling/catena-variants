...
Registry<argonCFBla> regacfb;

argonCFBla::argonCFBla()
:Registerable("ArgonCFBla", "ACB", "Argon 2 compression function with Blamka")
{}

void
argonCFBla::ResetState() {}
...
void
argonCFBla::Hash(int vindex, const uint8_t* i1, const uint8_t* i2, 
            uint8_t* hash)
{
