...
Registry<Blake2b1> regB2b1;

Blake2b1::Blake2b1()
:Registerable("Blake2b-1", "B2b1", "Single round of Blake2b(SSE or reference)")
{
  _state = (blake2b_state*)aligned_alloc(64,sizeof(blake2b_state));
}

Blake2b1::Blake2b1(Blake2b1 const& other)
:Registerable("Blake2b-1", "B2b1", "Single round of Blake2b(SSE or reference)")
{
  _state = (blake2b_state*)aligned_alloc(64,sizeof(blake2b_state));
...
Blake2b1& 
Blake2b1::operator=(Blake2b1 const& other)
{
  if(this != &other)
  {
    free(_state);
...
void 
Blake2b1::Hash(int vindex, const uint8_t* i1, const uint8_t* i2, 
	uint8_t hash[H_LEN])
{
